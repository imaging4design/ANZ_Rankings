...
{	
	...
	public function edit_athlete()
	{
		...
		echo $this->update_text_message = '<span class="message_success">Athlete details updated!</span>';
	...
	public function delete_athlete()
	{
		...
		if($this->form_validation->run() == TRUE) 
		{
			...
			echo $this->update_text_message = '<span class="message_success">Athlete Deleted!</span>';
		}
