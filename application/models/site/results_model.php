...
class Results_Model extends CI_Model
{
	...
	public function __construct()
	{
		...
		{
			$this->year = "YEAR(results.date) = ". $this->input->post('year');
		}
		...
		{
			$this->limit_by = $this->input->post('list_depth');
		}
		...
		$config_gender_list = ( $this->input->post( 'ageGroup' ) == 'MS' ) ? 'all_time_men' : 'all_time_women';
	...
	public function legal_vs_windy($athleteID)
	{
		...
		$this->db->where('YEAR(results.date)', $this->input->post('year'));
